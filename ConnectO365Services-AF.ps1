<#
Removed from services & ValidateSet
'SharePointPnP',
'SharePoint',
'SharePointPnP',
'SharePoint',
...
(
    ...
    [switch]$Disconnect,
    [ValidateSet('AzureAD','MSOnline','ExchangeOnline','SecAndCompCenter','Teams')]
    [string[]]$Services=("AzureAD","MSOnline","ExchangeOnline",'SecAndCompCenter','Teams'),
    [Switch]$MFA,
    [string]$UserName, 
    [String]$Password
)
